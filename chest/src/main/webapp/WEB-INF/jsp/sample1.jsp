...
<body style="text-align:center; margin:0 auto; display:inline; padding-top:100px;">
    ...
    <%-- <div id="div-loginValue" data-loginValue="${loginValue}"></div> --%>
      ...
      <table>
        ...
        <td rowspan="2"><button style="width:50px; height:50px; border: solid blue 1px;">로그인</button></td>
        </tr>
        <tr>
        <td>
...
/* var loginValue=$("#div-loginValue").attr("data-loginValue"); */
