...
<head>
    ...
    <title>Sample2 <c:if test="${registerFlag == 'create'}"><spring:message code="button.create" /></c:if>
    ...
    <script type="text/javaScript" language="javascript" defer="defer">
        ...
        function fn_egov_selectList() {
        	$.ajax({
        		...
        		success:function(result) {
        			if(result == 'true') {
                        document.detailForm.action = "<c:url value='/egovSampleList2.do'/>"; 
        ...
        function fn_egov_delete() {
           	document.detailForm.action = "<c:url value='/deleteSample2.do'/>";
           	document.detailForm.submit();
        }
...
<body style="text-align:center; margin:0 auto; display:inline; padding-top:100px;">
	<a href="/login2.do?selectedId=${sampleVO.id}">login</a>&nbsp;
    <a href="/logout2.do?selectedId=${sampleVO.id}">logout</a>
    <br/>
	...
	<div class="login-dialog">
      <table>
        ...
        <td rowspan="2"><button id="btn-login" style="width:50px; height:50px; border: solid blue 1px;">로그인</button></td>
        </tr>
        <tr>
        <td>
...
var loginValue="<c:out value='${loginValue}'/>"; 
